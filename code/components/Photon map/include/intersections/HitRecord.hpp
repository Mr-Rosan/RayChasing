...
inline HitRecord getHitRecord(float t, const Vec3& hitPoint, const Vec3& normal, float pdf, const Vec3& radiance, Handle material) {
    return make_optional<HitRecordBase>(t, hitPoint, normal, material, pdf, radiance);
}
